...
**Version 2.0.2** introduces the complete **"Ink & Signal" UI redesign** — a warm dark editorial theme with locally bundled fonts, five pages (Repository, Dashboard, History, Docs, About), a command palette, and every view wired to real Git data through the existing Go bindings.
